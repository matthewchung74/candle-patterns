    ...
    def detect(
        ...
        return PatternResult(
            ...
            details={
                ...
                "breakout_time": breakout_time.strftime("%H:%M") if hasattr(breakout_time, "strftime") else "",
                "retest_idx": int(last_idx),
                "retest_time": entry_candle["ts_et"].strftime("%H:%M") if hasattr(entry_candle["ts_et"], "strftime") else "",
                "fvg": fvg_found,
                "confirmed": confirmed,
